...
| transferElem                   | 选填 | object  | 转账通知内容,如果选用该模版，下列字段为必填项目                                                                                                    |
| transferElem.sendID            | 选填 | string  | 发送者 ID                                                                                                                                          |
| transferElem.recvID            | 选填 | string  | 接收者 ID                                                                                                                                          |
| transferElem.SenderNickname    | 选填 | string  | 发送者昵称                                                                                                                                         |
| transferElem.RecvNickname      | 选填 | string  | 接收者昵称                                                                                                                                         |
| transferElem.coinNum           | 必填 | string  | 货币数量                                                                                                                                           |
| transferElem.coinType          | 必填 | string  | 货币单位                                                                                                                                           |
| transferElem.content           | 选填 | string  | 描述                                                                                                                                               |
| transferElem.transactionStatus | 必填 | string  | 转账状态 1-成功 2-失败                                                                                                                             |
| transferElem.transactionType   | 必填 | string  | 通知的类型 1-钱包 2-红包                                                                                                                           |
| transferElem.transactionHash   | 必填 | string  | 交易 hash                                                                                                                                          |
