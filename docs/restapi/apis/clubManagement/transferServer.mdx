...
- `post` 
### 请求URL
- `http://x.x.x.x:10002/club/transfer_server` 
...
{
    "serverID":"1736658435",
    "oldOwnerUserID":"payAdmin",
    "newOwnerUserID":"openIMAdmin"
}
```
|字段名|选填|类型|说明|
|:----    |:-------    |:--- |---|
|serverID|必填|string|部落ID|
|oldOwnerUserID|必填|string|原部落主ID|
|newOwnerUserID|必填|string|新部落主ID|
